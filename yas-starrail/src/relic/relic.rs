...
impl RelicSetName {
    ...
    pub fn from_zh_cn(s: &str) -> Option<RelicSetName> {
        match s {
            ...
            "司铎的律音耳坠" | "司铎的授邀手套" | "司铎的圣职礼服" | "司铎的苦旅短靴" => Some(RelicSetName::SacerdosRelivedOrdeal),
            "学者的银边视镜" | "学者的辅助指节" | "学者的粗纺外套" | "学者的绒皮雪靴" => Some(RelicSetName::ScholarLostinErudition),
            "英豪的冠军桂冠" | "英豪的鉴金腕铠" | "英豪的骁战金甲" | "英豪的赴火护胫" => Some(RelicSetName::HeroofTriumphantSong),
            "诗人的莳萝花冠" | "诗人的贵金手镯" | "诗人的缀星裙摆" | "诗人的钉银之履" => Some(RelicSetName::PoetofMourningCollapse),
            "女武神的翱翔翼盔" | "女武神的骑枪手铠" | "女武神的启程披风" | "女武神的勋礼马刺" => Some(RelicSetName::WarriorGoddessofSunandThunder),
            "船长的领航笠帽" | "船长的捕光星盘" | "船长的驭风斗篷" | "船长的踏浪游靴" => Some(RelicSetName::WavestriderCaptain),
            ...
            "哀地里亚的殁名祭碑" | "哀地里亚的入溟骨链" => Some(RelicSetName::BoneCollectionsSereneDemesne),
            "神悟树庭的沉思巨桹" | "神悟树庭的联识叶路" => Some(RelicSetName::GiantTreeofRaptBrooding),
            _ => None,
        }
    }
}
...
impl RelicSlot {
    ...
    pub fn from_zh_cn(s: &str) -> Option<RelicSlot> {
        match s {
            "过客的逢春木簪" | "快枪手的野穗毡帽" | "圣骑的宽恕盔面" | "雪猎的荒神兜帽" | "拳王的冠军护头" | "铁卫的铸铁面盔" | "火匠的黑耀目镜" | "天才的超距遥感" | "乐队的偏光墨镜" | "翔鹰的长喙头盔" | "怪盗的千人假面" | "废土客的呼吸面罩" | "莳者的复明义眼" | "信使的全息目镜" | "大公的冥焰冠冕" | "系囚的合啮拘笼" | "先驱的绝热围壳" | "钟表匠的极目透镜" | "铁骑的索敌战盔" | "勇烈的玄枵面甲" | "司铎的律音耳坠" | "学者的银边视镜" | "英豪的冠军桂冠" | "诗人的莳萝花冠" | "女武神的翱翔翼盔" | "船长的领航笠帽" => Some(RelicSlot::Head),
            "过客的游龙臂鞲" | "快枪手的粗革手套" | "圣骑的沉默誓环" | "雪猎的巨蜥手套" | "拳王的重炮拳套" | "铁卫的银鳞手甲" | "火匠的御火戒指" | "天才的频变捕手" | "乐队的巡演手绳" | "翔鹰的鹰击指环" | "怪盗的绘纹手套" | "废土客的荒漠终端" | "莳者的机巧木手" | "信使的百变义手" | "大公的绒火指套" | "系囚的铅石梏铐" | "先驱的虚极罗盘" | "钟表匠的交运腕表" | "铁骑的摧坚铁腕" | "勇烈的钩爪腕甲" | "司铎的授邀手套" | "学者的辅助指节" | "英豪的鉴金腕铠" | "诗人的贵金手镯" | "女武神的骑枪手铠" | "船长的捕光星盘" => Some(RelicSlot::Hands),
            "过客的残绣风衣" | "快枪手的猎风披肩" | "圣骑的肃穆胸甲" | "雪猎的冰龙披风" | "拳王的贴身护胸" | "铁卫的旧制军服" | "火匠的阻燃围裙" | "天才的元域深潜" | "乐队的钉刺皮衣" | "翔鹰的翼装束带" | "怪盗的纤钢爪钩" | "废土客的修士长袍" | "莳者的承露羽衣" | "信使的密信挎包" | "大公的蒙恩长袍" | "系囚的幽闭缚束" | "先驱的密合铅衣" | "钟表匠的空幻礼服" | "铁骑的银影装甲" | "勇烈的飞翎瓷甲" | "司铎的圣职礼服" | "学者的粗纺外套" | "英豪的骁战金甲" | "诗人的缀星裙摆" | "女武神的启程披风" | "船长的驭风斗篷" => Some(RelicSlot::Body),
            "过客的冥途游履" | "快枪手的铆钉马靴" | "圣骑的秩序铁靴" | "雪猎的鹿皮软靴" | "拳王的弧步战靴" | "铁卫的白银护胫" | "火匠的合金义肢" | "天才的引力漫步" | "乐队的铆钉短靴" | "翔鹰的绒羽绑带" | "怪盗的流星快靴" | "废土客的动力腿甲" | "莳者的天人丝履" | "信使的酷跑板鞋" | "大公的绅雅礼靴" | "系囚的绝足锁桎" | "先驱的泊星桩锚" | "钟表匠的隐梦革履" | "铁骑的行空护胫" | "勇烈的逐猎腿甲" | "司铎的苦旅短靴" | "学者的绒皮雪靴" | "英豪的赴火护胫" | "诗人的钉银之履" | "女武神的勋礼马刺" | "船长的踏浪游靴" => Some(RelicSlot::Feet),
            "「黑塔」的空间站点" | "罗浮仙舟的天外楼船" | "公司的巨构总部" | "贝洛伯格的存护堡垒" | "螺丝星的机械烈阳" | "萨尔索图的移动城市" | "塔利亚的钉壳小镇" | "翁瓦克的诞生之岛" | "泰科铵的镭射球场" | "伊须磨洲的残船鲸落" | "格拉默的铁骑兵团" | "匹诺康尼的堂皇酒店" | "茨冈尼亚的母神卧榻" | "出云的祸津众神" | "都蓝的穹窿金帐" | "铸炼宫的莲华灯芯" | "露莎卡的水朽苍都" | "蕉乐园的蕉芯广场" | "哀地里亚的殁名祭碑" | "神悟树庭的沉思巨桹" => Some(RelicSlot::PlanarSphere),
            "「黑塔」的漫历轨迹" | "罗浮仙舟的建木枝蔓" | "公司的贸易航道" | "贝洛伯格的铁卫防线" | "螺丝星的环星孔带" | "萨尔索图的晨昏界线" | "塔利亚的裸皮电线" | "翁瓦克的环岛海岸" | "泰科铵的弧光赛道" | "伊须磨洲的坼裂缆索" | "格拉默的寂静坟碑" | "匹诺康尼的逐梦轨道" | "茨冈尼亚的轮回纽结" | "出云的终始一刀" | "都蓝的器兽缰辔" | "铸炼宫的焰轮天绸" | "露莎卡的双生航道" | "蕉乐园的模因线缆" | "哀地里亚的入溟骨链" | "神悟树庭的联识叶路" => Some(RelicSlot::LinkRope),
            _ => None,
        }
    }
}